...
while not done:
  ...
  #  pygame.draw.polygon(screen, BLACK, [[50, 50], [100, 50], [100, 50],[50,0]], 5)

    pygame.draw.lines(screen, BLACK, False, [(100,100), (150,200), (200,100)], 1)
    pygame.draw.lines(screen, BLACK, False, [(100,100), (150,0), (200,100)], 1)

    pygame.draw.lines(screen, BLACK, True, [(100,100), (400,100), (300,200),(0,200)], 1)
